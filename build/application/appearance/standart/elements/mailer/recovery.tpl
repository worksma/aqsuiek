...
<head>
  ...
  <!--[if !mso]>
      <!-- -->
  <link href='https://fonts.googleapis.com/css?family=Montserrat:400,400italic,700,700italic%27' rel='stylesheet' type='text/css'>
  <!--<![endif]-->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                    ...
                                    <img align="center" alt="Забыли свой пароль?" class="mcnImage" src="https://static.lingoapp.com/assets/images/email/il-password-reset@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 color: #2a2a2a; font-family: "Montserrat", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">

                                <h1 class="null" style='color: #2a2a2a; font-family: "Montserrat", Helvetica,
 ...
 padding: 0'><span style="text-transform:uppercase">ЗАБЫЛИ</span></h1>


                                <h2 class="null" style='color: #2a2a2a; font-family: "Montserrat", Helvetica,
 ...
 padding: 0'><span style="text-transform:uppercase">свой пароль?</span></h2>
 ...
 color: #2a2a2a; font-family: "Montserrat", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Не волнуйтесь, мы с Вами справимся!<br>Давайте придумаем Вам новый пароль.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 font-family: 'Montserrat', Helvetica, sans-serif; font-size: 16px; padding-top:24px;
 ...
 font-family: 'Montserrat', Helvetica, sans-serif;" text-align="left" width="100%">
                          <tr>
                            <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">

                              <h3 style='color: #2a2a2a; font-family: "Montserrat", Helvetica, sans-serif;
 ...
 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>Что такое AQSUIEK?</h3>
 ...
 font-family: "Montserrat", Helvetica, sans-serif; font-size: 12px; line-height: 150%;
 text-align: left; text-align: left; font-size: 14px; '>AQSUIEK - это динамичное место встречи для разработчиков, инженеров и всех, кто интересуется технологиями. Здесь вы можете делиться своим опытом, публиковать статьи, обсуждать актуальные темы и находить вдохновение.
                              </p>
                              <div style="padding-bottom: 18px;">
                                <a href="https://aqsuiek.kz" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none;
 font-size: 14px; color:#F57153; text-decoration:none;" target="_blank" title="Читать о AQSUIEK">Подробнее ❯</a>
                              </div>
                            </td>
                          </tr>
                        </table>
 ...
 padding-bottom: 24px; padding-left: 18px; color: #7F6925; font-family: 'Montserrat',
