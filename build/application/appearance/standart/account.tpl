...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" href="/public/assets/{appearance}/css/custom/login.css?v={cache}">
		<link rel="stylesheet" href="/public/assets/{appearance}/css/responsive.css?v={cache}">
